...
<body id="danceBody">
    ...
    <a class="arrow-down" href="#danceCard1"><svg xmlns="http://www.w3.org/2000/svg" width="48" height="48"
    ...
    <div class="row justify-content-center">
                ...
                <div class="danceCardType1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 justify-content-center">
                            ...
                            <input type="button" onclick="location.href='dancedetailedpage?id=<?= $artist->getId() ?>'"
                                class="danceViewMore" value=" view more">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row justify-content-center" id="tickets">
            ...
            <div class="d-flex justify-content-around">
                <button type="button" id="danceAllAccessPass" onclick="addAllAccessTicketToCart(65)"> Buy ticket for
                    all-access pass for entire festival:
                    €250,00</button>
            </div>
            <div class="col-4 d-flex justify-content-around">
                <button type="button" class="danceDailyAccessPass" onclick="addAllAccessTicketToCart(66)"> Buy
                    all-access pass only for 1st day
                    €125,00</button>
            </div>
            <div class="col-4 d-flex justify-content-around">
                <button type="button" class="danceDailyAccessPass" onclick="addAllAccessTicketToCart(67)"> Buy
                    all-access pass only for 2nd day
                    €150,00</button>
            </div>
            <div class="col-4 d-flex justify-content-around">
                <button type="button" class="danceDailyAccessPass" onclick="addAllAccessTicketToCart(68)"> Buy
                    all-access pass only for 3rd day
                    €150,00</button>
            </div>
        </div>
        <div>
                                            ...
                                            <td>
                                                <?php if ($ticket->getAvaliableTickets() != 0) { ?>
                                                    ...
                                                    <button class="btn btn-light rounded-0"
                                                        onclick="addTicketToCart(<?= $ticket->getId() ?>)">Add to cart</button>
                                                <?php } else {
                                                    ?>
                                                    <p>
                                                        Sold out
