        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <tbody>
                <?php foreach ($venues as $venue) { ?>
                    <form method="POST">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control venue-name" name="venueName" value="<?= $venue->getVenueName() ?>">

                            </td>
                            <td class="address">
                                <input type="text" class="form-control address" value="<?= $venue->getAddress() ?>" name="venueAddress">
                            </td>
                            <td>
                ...
                <form method="POST">
                    ...
                    <td>
                        <button type="submit" class="btn btn-success" name="action" action="add" value="addVenue">Add</button>
                    </td>
                </form>
            </tbody>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            foreach ($artists as $artist) { ?>
                <form method="POST">
                    <tr>
                        ...
                        <td>
                            <input type='text' name='artistFirstSourceSong' value='<?= $artist->getFirstSongSource() ?>'>
                            <input type='text' name='artistSecondSourceSong' value='<?= $artist->getSecondSongSource() ?>'>
                            <input type='text' name='artistThirdSourceSong' value='<?= $artist->getThirdSongSource() ?>'>
                        </td>
                        <td>
                            <input type="text" name="artistDetailedPicture" value="<?= $artist->getDetailedPicture() ?>">
                        </td>
                        <td>
                            <input type="text" name="artistCareer" value="<?= $artist->getCareer() ?>">
                        </td>
                        <td>
                            <button type="submit" class="btn btn-primary edit-btn" name="action" action="update" value="updateArtist">Update</button>
                            <button type="submit" class="btn btn-danger delete-btn" name="action" value="deleteArtist" action="deleteArtist">Delete</button>
                        </td>
                    </tr>
                </form>
            <?php } ?>
            <form method="POST">
                <tr>
                    ...
                    <td>
                        <button type="submit" class="btn btn-success" name="action" action="add" value="addArtist">Add</button>
                    </td>
                </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name="ticketVenue">
                                        <?php foreach ($venues as $venue) : ?>
                                            <option value="<?= $venue->getVenueName() ?>" <?= $venue->getVenueName() === $ticket->getVenue() ? 'selected' : '' ?>>
                                                <?= $venue->getVenueName() ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <td>
                                    <button type="submit" class="btn btn-primary edit-btn" name="action" action="update" value="updateTicket">Update</button>
                                    <button type="submit" class="btn btn-danger delete-btn" name="action" value="deleteTicket" action="deleteTicket">Delete</button>
                                </td>
                            </tr>
                        </form>
                    <?php } ?>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            <form method="POST" name="table">
                <tr>
                    ...
                    <td>
                        <button type="submit" class="btn btn-success" name="action" action="add" value="addTicket">Add</button>
                    </td>
                </tr>
            </form>
        </table>
